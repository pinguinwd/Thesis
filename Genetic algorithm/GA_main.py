...
def genetic_algorithm(ga_params):
    ...
    (training_inputs, training_outputs), (control_inputs, control_outputs) = generate_input_output_pairs(sort=ga_params['case_study'],
    ...
    for generation in range(generations):
        ...
        for individual in population:
            ...
            fitness = evaluate_fitness(individual['chromosome'], training_inputs, training_outputs, input_cells, output_cells, ga_params['steps'],
                    ga_params['distance'])
        ...
        if generation % 20 == 0 or generation == 0:
            ...
            for individual in population:
                ...
                fitnesses = evaluate_fitness_control(individual['chromosome'], control_inputs, control_outputs, input_cells, output_cells, ga_params['steps'],
                    ga_params['distance'])
...
def generate_random_configuration():
    ...
    crossover_options = {
        'single_point': {'type': 'single_point', 'rate': 0.5}
    }
    ...
    distance_options = ['euclidean']
    case_study_options = ['wine']
    input_location_options = ['evenly_distributed']
    input_order_options = ['ordered']
    sort_rules_options = ['random']
    chromosome_evol_options = ['yes']
    input_loc_evol = ['no']
    output_loc_evol = ['no']
