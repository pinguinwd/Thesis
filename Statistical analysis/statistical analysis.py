...
def vary_uni_vs_non_uni(SIMULATIONS):
    ...
    for secondrule in range(0, 255):
        ...
        plot_difference_pattern(all_states_oc, all_states_new, dif, 'central', SIMULATIONS, firstrule,  secondrule, 'ruleflip')
    ...
    for secondrule in range(0, 255):
        ...
        for sim in range(SIMULATIONS):
            ...
            if sim == 0 and secondrule in plotrules:
                # Create subplots
                plot_difference_pattern(all_states_oc, all_states_new, dif, 'loc', SIMULATIONS, firstrule, secondrule, 'ruleflip')
...
def vary_inicond(SIMULATIONS, firstrule):
    ...
    for secondrule in range(0, 255):
        ...
        for sim in range(SIMULATIONS):
            ...
            print('len(all_states_oc): ', len(all_states_oc))
            print('len(all_states_new): ', len(all_states_new))
            print('secondrule: ', secondrule)

            if True: #sim == 0 and secondrule in plotrules
                # Create subplots
                plot_difference_pattern(all_states_oc, all_states_new, dif, 'seed', SIMULATIONS, firstrule, secondrule, 'ruleflip')
