...
plotrules = [i for i in range(0,255)]
#%%
...
def save_image_to_onedrive(name, image):
    ...
    general_folder_path = 'D:/user/Documents/unief/2e master/Thesis/tmp/'
...
def plot_difference_pattern(all_states_oc, all_states_new, dif, reason, SIMULATIONS, firstrule, secondrule, change):
    # Create subplots
    ...
    # Show the figure
    name = change + '_' + reason + '__firstrule= ' + str(firstrule) + '_sec_rule= ' + str(secondrule) + '_sim=' + str(
        SIMULATIONS)
    save_image_to_onedrive(name, plt)
    plt.close()
    ...
    for secondrule in range(0, 255):
        ...
        for sim in range(SIMULATIONS):
            ...
            if sim == 0 and secondrule in plotrules:
                # Create subplots
                plot_difference_pattern(all_states_oc, all_states_new, dif, 'loc', SIMULATIONS, firstrule, secondrule, 'bitflip')
...
def vary_rules(SIMULATIONS):
    ...
    for secondrule in range(0, 255):
        ...
        for sim in range(SIMULATIONS):
            ...
            if sim == 0 and secondrule in plotrules:
                # Create subplots
                plot_difference_pattern(all_states_oc, all_states_new, dif, 'rules', SIMULATIONS, firstrule, secondrule, 'bitflip')
...
def vary_seed(SIMULATIONS):
    ...
    for secondrule in range(0, 255):
        ...
        for sim in range(SIMULATIONS):
            ...
            if sim == 0 and secondrule in plotrules:
                # Create subplots
                plot_difference_pattern(all_states_oc, all_states_new, dif, 'seed', SIMULATIONS, firstrule, secondrule, 'bitflip')
...
def save_text_to_onedrive(action, var2, var3, var4=None, var5=None):
    ...
    base_path = "D:/user/Documents/unief/2e master/Thesis/tmp/"
